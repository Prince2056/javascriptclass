function validFname(){
 ...
 if(first_name==""){
    ...
    return false
     ...
     displayMsg('firstname only accepts aplhapets','fnameMsg','red')
     return false
 }
 else{
...
function validLname(){
 ...
 if(last_name==""){
    ...
    return false
     ...
     displayMsg('lastname only accepts aplhapets','lnameMsg','red')
     return false
 }
 else{
...
function validpassword(){
    ...
    if(password==""){
     ...
     displayMsg('must contain one uppercase,one lowercase,one numeric,one special character and must be more than 8characters','red')
     return false
 }
    else{
